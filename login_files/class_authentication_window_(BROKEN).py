...
from ui_files.raw_ui.ui_auth_stackedwidget import Ui_AuthStackedWidget
from ui_files.class_login_widget import LoginWidget
...
class AuthenticationWindow(BaseLoginForm, EmailSender): 
    ...
    def handle_login(self):
        ...
        login_input = self.login_page.ui.lineEditUsername.text().strip()
    ...
    def handle_password_reset_request(self):
        email_input = self.reset_password_page.ui.lineEditRegisteredEmail.text().strip()
    ...
    def handle_reset_code_confirmation(self):
        entered_code = self.reset_password_page.ui.lineEditCode.text().strip()

...
class AddGradesDialog(QDialog):
    ...
    def __init__(self, admin_utils: AdminUtilities, db: DatabaseUtilities, parent=None):
        ...
        # Disable grade selection until a course is selected
        ...
        # Grade selection enabled only when a valid course is chosen
    ...
    def on_course_changed(self):
        """
        Grade selection becomes available only when a valid course is chosen.
        Prevents saving a grade with no course.
        """

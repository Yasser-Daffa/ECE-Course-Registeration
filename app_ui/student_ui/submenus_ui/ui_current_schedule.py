...
"")
    ...
    def retranslateUi(self, AllStudents):
        ...
        item.setText(_translate("AllStudents", "COURSE ID"))
        item = self.tableCourses.horizontalHeaderItem(3)
        item.setText(_translate("AllStudents", "CREDIT"))
        item = self.tableCourses.horizontalHeaderItem(4)
        item.setText(_translate("AllStudents", "SECTION"))
        item = self.tableCourses.horizontalHeaderItem(5)
        item.setText(_translate("AllStudents", "DAYS"))
        item = self.tableCourses.horizontalHeaderItem(6)
        item.setText(_translate("AllStudents", "TIME"))
        item = self.tableCourses.horizontalHeaderItem(7)
        item.setText(_translate("AllStudents", "ROOM"))
        item = self.tableCourses.horizontalHeaderItem(8)
        item.setText(_translate("AllStudents", "INSTRUCTOR"))

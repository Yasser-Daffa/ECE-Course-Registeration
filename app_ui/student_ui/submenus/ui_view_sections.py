...
class Ui_ViewSections(object):
    def setupUi(self, ViewSections):
        ...
        self.totalSectionsFrame = QtWidgets.QFrame(parent=ViewSections)
        self.totalSectionsFrame.setMinimumSize(QtCore.QSize(0, 140))
        self.totalSectionsFrame.setMaximumSize(QtCore.QSize(200, 16777215))
        ...
        self.labelTotalSectionsCount.setStyleSheet("font-size: 26px; font-weight: bold; color: #2c3e50; background: transparent;")
        ...
        self.openSectionsFrame = QtWidgets.QFrame(parent=ViewSections)
        self.openSectionsFrame.setMinimumSize(QtCore.QSize(0, 140))
        self.openSectionsFrame.setMaximumSize(QtCore.QSize(200, 16777215))
        ...
        self.labelOpenSectionsCount.setStyleSheet("font-size: 26px; font-weight: bold; color: #2c3e50; background: transparent;")
        ...
        self.fullSectionsFrame = QtWidgets.QFrame(parent=ViewSections)
        ...
        self.closedSectionsFrame = QtWidgets.QFrame(parent=ViewSections)
        ...
        self.labelClosedSectionsCount.setStyleSheet("font-size: 26px; font-weight: bold; color: #2c3e50; background: transparent;")
...
"")
    ...
    def retranslateUi(self, ViewSections):
        ...
        self.totalSectionsIcon.setText(_translate("ViewSections", "📚"))
        self.labelTotalSectionsCount.setText(_translate("ViewSections", "85"))
        self.labelTotalSections.setText(_translate("ViewSections", "Total Sections"))
        self.openSectionsIcon.setText(_translate("ViewSections", "🔓"))
        self.labelOpenSectionsCount.setText(_translate("ViewSections", "62"))
        self.labelOpenSections.setText(_translate("ViewSections", "Open Sections"))
        self.fullSectionsIcon.setText(_translate("ViewSections", "🔒"))
        self.labelFullSectionsCount.setText(_translate("ViewSections", "18"))
        self.labelFullSections.setText(_translate("ViewSections", "Full Sections"))
        self.closedSectionsIcon.setText(_translate("ViewSections", "❌"))
        self.labelClosedSectionsCount.setText(_translate("ViewSections", "5"))
        self.labelClosedSections.setText(_translate("ViewSections", "Closed Sections"))
        ...
        self.comboBoxFilterCourses.setItemText(1, _translate("ViewSections", "ECE 101"))
        self.comboBoxFilterCourses.setItemText(2, _translate("ViewSections", "ECE 202"))
        self.comboBoxFilterCourses.setItemText(3, _translate("ViewSections", "ECE 303"))
        self.comboBoxFilterCourses.setItemText(4, _translate("ViewSections", "ECE 404"))
        ...
        self.comboBoxStatusFilter.setItemText(2, _translate("ViewSections", "Full"))
        self.comboBoxStatusFilter.setItemText(3, _translate("ViewSections", "Closed"))
        self.buttonRegisterCourse.setText(_translate("ViewSections", "Register Course"))
        item = self.tableSections.horizontalHeaderItem(0)
        item.setText(_translate("ViewSections", "SELECT"))
        ...
        item.setText(_translate("ViewSections", "ACTIONS"))

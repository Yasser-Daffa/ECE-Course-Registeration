...
"")
    ...
    def retranslateUi(self, RegisterCourses):
        ...
        self.buttonAddCourse.setText(_translate("RegisterCourses", "➕ Add New Course (to plan)"))
        self.buttonRemoveCourse.setText(_translate("RegisterCourses", "❌ Remove Course (from plan)"))

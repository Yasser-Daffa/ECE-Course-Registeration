...
class AuthWindow(QWidget): 
    def __init__(self):
        ...
        self.reset_password_page: ResetPasswordWidget = self.ui.stackedWidgetAuth.widget(2)
        ...
        self.reset_password_page.buttonBackToSignIn.clicked.connect(self.go_to_login)
    ...
    #     # Logic to submit the new account details to your database
    #     print("Registration submitted. Redirecting to login.")
    #     # After successful registration, send them back to the login screen
    #     self.go_to_login()
